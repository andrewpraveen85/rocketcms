...
if(isset($_POST['button']) && $_POST['button']=='Submit'){
	$updateSQL = "UPDATE `config` SET `values`='".htmlentities($_POST['editor'])."' WHERE constants='HOME'";
...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr>
    <td colspan="2" scope="row"><form id="form1" name="form1" method="post" action="">
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        <tr>
          <td><textarea name="editor" id="editor"><?php echo $row_HOME['values']; ?></textarea></td>
        </tr>
        <tr>
